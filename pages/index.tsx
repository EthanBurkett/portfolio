      ...
      <main className="w-screen h-screen overflow-hidden flex flex-row justify-center items-center text-[rgb(54,54,54)] font-['Raleway']">
        <div className="w-screen h-screen flex flex-col justify-center">
          ...
          <div className="flex flex-row absolute self-start bottom-32 gap-6">
            <div
              onClick={() => {
                window.location.href = "https://www.github.com/EthanBurkett";
              }}
              className="w-[64px] h-[64px] bg-[rgb(196,196,196)] rounded-sm drop-shadow-custom flex items-center justify-center pt-[5px] cursor-pointer"
            >
              <FaGithub
                size={40}
            ...
            <div
              onClick={() => {
                window.location.href =
                  "https://www.upwork.com/freelancers/~01ed5bf590476c3ebd";
              }}
              className="w-[64px] h-[64px] bg-[rgb(196,196,196)] rounded-sm drop-shadow-custom flex items-center justify-center pt-[5px] cursor-pointer"
            >
              <SiUpwork
            ...
            <div
              onClick={() => {
                window.location.href = "https://www.replit.com/@ethanburkett";
              }}
              className="w-[64px] h-[64px] bg-[rgb(196,196,196)] rounded-sm drop-shadow-custom flex items-center justify-center pt-[5px] cursor-pointer"
            >
              <SiReplit
